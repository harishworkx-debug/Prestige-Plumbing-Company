...
const coreServices: Service[] = [
  {
    ...
    tagline: "24/7 residential emergency plumbing services across Mesa and the Phoenix metro",
    metaTitle: "24/7 Emergency Plumber Mesa AZ | Residential Services | Prestige Plumbing",
    metaDescription: "Call our emergency residential plumbers in Mesa & Phoenix metro. Available 24/7 for burst pipes and water heater failures. Call (480) 681-3808 now.",
    image: "emergencyPlumbing",
    intro: [
      "A plumbing emergency does not schedule itself around business hours. Water travels fast, drywall absorbs it faster, and in Arizona's dry climate a hidden leak can quietly destroy framing and flooring. Prestige Plumbing Company helps homeowners hire our emergency professionals across Mesa, Phoenix, Chandler, Gilbert, Tempe and Scottsdale.",
      "When you call our emergency line, the first thing we do is help dispatch a local professional who can provide over-the-phone guidance to stop the damage while a technician is dispatched.",
      "our licensed emergency providers we dispatch arrive with trucks stocked as complete mobile workshops. That inventory helps them complete residential repairs quickly.",
    ],
    benefits: [
      "24/7 immediate dispatch of our local plumbers",
      "Over-the-phone guidance to stop water damage while providers are en route",
      "Services to providers with fully stocked trucks",
      "Our team of licensed residential emergency technicians",
    ...
    detail: [
      {
        ...
        body: [
          "The priority on a residential emergency call is stopping the progression of damage. expert plumbers identify and isolate the source immediately. Only once the home is safe from further damage do they pivot to diagnosis and repair.",
          "If the emergency involves extensive flooding, professionals will also advise on safe electrical practices for homeowners.",
        ],
      },
    ],
    steps: [
      { title: "Schedule", text: "Call our service to schedule a visit from one of our licensed plumbers." },
      { title: "Diagnose", text: "The local provider traces the failure to its source in your home." },
      { title: "Quote", text: "You receive a firm, flat-rate price for the repair directly from the our licensed contractor." },
      { title: "Repair", text: "The repair is completed by the our licensed professional using high-quality parts." },
    ],
    maintenance: [
    ...
    faqs: [
      ...
      { q: "Do the our licensed plumbers charge extra for nights and weekends?", a: "Providers typically have specific emergency dispatch rates for after-hours calls, but the repair itself is quoted flat-rate before they begin." },
      { q: "Can a provider fix a burst pipe inside a wall tonight?", a: "Yes. Many licensed plumbers carry the necessary parts to complete in-wall pipe repairs for homeowners immediately." },
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners expert repair and replacement for water heaters",
    metaTitle: "Water Heater Repair & Installation Mesa AZ | Residential Services",
    metaDescription: "Residential water heater services in Mesa, AZ. Call our pros for repair, replacement and tankless installation. Call (480) 681-3808.",
    image: "waterHeaters",
    intro: [
      ...
      "Prestige Plumbing Company provides comprehensive water heater services across the East Valley. We dispatch local professionals who repair and install traditional tank heaters and high-efficiency tankless systems.",
      "our licensed contractors can help you decide which residential system suits your home. They evaluate gas supply, venting and water treatment for homeowners.",
    ],
    benefits: [
      "Services to providers offering fast residential replacements",
      "Expert diagnosis of heating element and thermostat failures",
      "Professional services for tankless water heater conversions",
    ...
    detail: [
      {
        ...
        body: [
          "Not every issue requires a new heater for your home. expert plumbers routinely replace faulty thermocouples and heating elements to restore function to residential units. However, if the steel tank itself has fractured, replacement is the only option.",
    ...
    steps: [
      { title: "Evaluate", text: "The our licensed professional tests the electrical or gas components and inspects the tank integrity." },
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners professional drain cleaning and sewer line repair",
    metaTitle: "Residential Drain Cleaning & Sewer Repair Mesa AZ | Prestige Plumbing",
    metaDescription: "Residential drain cleaning and sewer repair services in Mesa, AZ. Call our pros for camera inspections. Call (480) 681-3808.",
    image: "drainAndSewer",
    intro: [
      ...
      "Prestige Plumbing Company helps homeowners call our local pros who approach drain clearing systematically. expert plumbers use cabling machines and high-resolution sewer cameras to visually verify the residential line is clear.",
      "Whether you have a single backed-up kitchen sink or a collapsed clay sewer line in an older neighborhood, we dispatch a permanent solution provider.",
    ],
    benefits: [
      "Services for visual verification of residential blockages with cameras",
      ...
      "Our team of experienced expert plumbers",
    ],
    problems: [
    ...
    steps: [
      { title: "Inspect", text: "expert plumbers often begin with a camera inspection to identify the exact nature of the blockage in your home." },
    ...
    faqs: [
      ...
      { q: "Can a provider repair broken sewer lines under my yard?", a: "Yes. expert plumbers can locate the break point, excavate locally, repair the damaged residential section, and restore the trench." },
      { q: "How much does a residential sewer camera inspection cost?", a: "Pricing is set by the our licensed contractor, usually flat-rate depending on the home access point." },
    ],
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners pros to pinpoint hidden leaks behind walls and slabs",
    metaTitle: "Residential Leak Detection & Slab Leak Repair Mesa AZ",
    metaDescription: "Professional residential leak detection services in Mesa. Find pros using acoustic equipment to locate home leaks. Call (480) 681-3808.",
    image: "leakDetection",
    intro: [
      ...
      "Finding a leak under a concrete slab requires specialized technology. Prestige Plumbing Company connects homeowners with our licensed pros who use sensitive acoustic listening devices and thermal imaging cameras to pinpoint pipe failures.",
    ...
    benefits: [
      ...
      "Services to pros using thermal and acoustic technology",
      ...
      "licensed plumbers can assist with documentation for homeowner's insurance",
    ],
    problems: [
    ...
    steps: [
      { title: "Test", text: "The our licensed provider pressure tests the hot and cold systems in your home." },
      ...
      { title: "Execute", text: "The our licensed contractor completes the repair and restores home water service." },
    ],
    maintenance: [
    ...
    faqs: [
      { q: "Does homeowner's insurance cover residential slab leaks?", a: "Insurance typically covers the damage caused by the water (drywall, flooring) but rarely the cost of the plumbing repair itself. our licensed pros can provide documentation for adjusters." },
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners pros for whole-home repiping and pipe replacements",
    metaTitle: "Whole Home Repiping Mesa AZ | Residential Plumbing Services",
    metaDescription: "Expert whole-home repiping services in Mesa. Call our pros to replace failing polybutylene and copper pipes in your home. Call (480) 681-3808.",
    image: "repiping",
    intro: [
      ...
      "When residential spot repairs become a monthly occurrence, a whole-home repipe is a sound decision for homeowners. Prestige Plumbing Company helps dispatch experts in full-scale residential repiping.",
      "our licensed contractors replace aging home systems with modern, highly durable PEX tubing, which is immune to internal corrosion.",
    ],
    benefits: [
    ...
    detail: [
      {
        ...
        body: [
          "A whole-home repipe sounds intimidating to homeowners, but our licensed pros use structured processes. They make strategic, minimal surgical cuts in the home drywall to route new lines.",
    ...
    steps: [
      { title: "Assess", text: "The our licensed contractor maps the existing plumbing layout in your home." },
    ...
    faqs: [
      ...
      { q: "Do the plumbers fix the holes in the home drywall afterward?", a: "our licensed plumbers make clean cuts, but they typically leave the patching to specialized residential drywall contractors." },
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners pros for safe residential gas line installation and repair",
    metaTitle: "Residential Gas Line Repair & Install Mesa AZ | Prestige Plumbing",
    metaDescription: "Residential gas line services in Mesa, AZ. Call our pros to run gas for stoves, fire pits, and pool heaters. Call (480) 681-3808.",
    image: "gasLine",
    intro: [
      ...
      "Whether you are upgrading your home kitchen to a gas range, running a new line to a backyard fire pit, or need emergency repair for a red-tagged leak, we dispatch local experts.",
      "our licensed contractors handle everything from initial sizing calculations for your home appliances to final pressure testing.",
    ],
    benefits: [
      "Services to pros who perform rigorous residential pressure testing",
      "Proper BTU load calculations for home appliances",
      "Expertise in residential gas materials",
      "Rapid dispatch for utility-mandated residential shutoffs",
      "Our team of expert plumbers familiar with city inspectors",
    ],
    problems: [
      "Active natural gas leaks at home appliance services",
    ...
    detail: [
      {
        ...
        body: [
          ...
          "our licensed contractors use combustible gas detectors to pinpoint the residential leak, perform repairs, and coordinate with inspectors.",
        ],
      },
    ],
    steps: [
      ...
      { title: "Inspect", text: "The our licensed provider coordinates with municipal inspectors for your home." },
    ],
    maintenance: [
    ...
    faqs: [
      { q: "Can I get connected with someone to run a gas line for my new home outdoor kitchen?", a: "Yes. We dispatch to homeowners pros who install underground gas lines for outdoor kitchens and fire pits." },
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners pros for toilet, shower, and sink repair",
    metaTitle: "Residential Bathroom Plumbing Mesa AZ | Prestige Plumbing",
    metaDescription: "Residential bathroom plumbing services in Mesa, AZ. Call our pros for toilet repair and shower valve replacement. Call (480) 681-3808.",
    image: "bathroomPlumbing",
    intro: [
      "The home bathroom sees the highest volume of water usage, making it a frequent site of plumbing failures. Prestige Plumbing Company helps homeowners call our local pros for residential bathroom plumbing.",
      "our licensed contractors handle repairs of existing home fixtures and rough-in plumbing for residential renovations.",
    ...
    benefits: [
      "Fast dispatch of pros for repairing running or leaking home toilets",
      "Expert services for rebuilding failing home shower valves",
    ...
    detail: [
      {
        ...
        body: [
          "When a home shower valve fails, replacing the brass body inside the wall is required. expert plumbers can often access the plumbing from the drywall on the opposite side to preserve your expensive residential shower enclosure.",
        ],
      },
    ],
    steps: [
      ...
      { title: "Repair", text: "The our licensed contractor rebuilds the home fixture or installs a replacement." },
    ...
    faqs: [
      ...
      { q: "My home bathroom sink drains very slowly. What should I do?", a: "We dispatch to homeowners pros who manually clear the p-trap for a permanent residential fix." },
      { q: "Do the plumbers install customer-supplied home fixtures?", a: "Yes. Most expert plumbers are happy to install fixtures that homeowners have purchased." },
    ],
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners pros for disposals, faucets, and sinks",
    metaTitle: "Residential Kitchen Plumbing Mesa AZ | Prestige Plumbing",
    metaDescription: "Residential kitchen plumbing services in Mesa. Call our pros for garbage disposal repair and faucet replacement. Call (480) 681-3808.",
    ...
    intro: [
      ...
      "expert plumbers clear stubborn grease clogs, replace failing home faucets, and install residential garbage disposals.",
      "Local contractors take meticulous care working around home countertops and custom cabinetry.",
    ],
    benefits: [
      "Services to pros for upgrading home garbage disposals",
    ...
    steps: [
      { title: "Inspect", text: "The our licensed pro checks the home disposal and faucet for leaks." },
      { title: "Clear/Repair", text: "The local contractor unjams the home disposal or replaces the faucet cartridge." },
      { title: "Upgrade", text: "The provider ensures secure, code-compliant services for new home fixtures." },
    ...
    faqs: [
      ...
      { q: "My home dishwasher is not draining. Can a plumber help?", a: "Often, yes. expert plumbers clear these connection points for homeowners." },
      { q: "Can I find someone to install a new home sink?", a: "Yes, we dispatch to homeowners pros who install sinks in existing cutouts." },
  ...
  },
  {
    ...
    tagline: "dispatching to homeowners pros for whole-home plumbing care",
    metaTitle: "Residential Plumber Services Mesa AZ | Prestige Plumbing",
    metaDescription: "Residential plumbing services in the East Valley. Call our pros for whole-home inspections and maintenance. Call (480) 681-3808.",
    image: "residentialPlumbing",
    intro: [
      "Your home's plumbing is an interconnected system. Prestige Plumbing Company helps homeowners Call our pros who offer proactive residential plumbing maintenance.",
      "our licensed contractors conduct thorough preventative home inspections and evaluate residential water pressure issues.",
      "Whether you need a baseline home inspection or a residential water softener, we dispatch the expertise to keep your home plumbing operating flawlessly.",
    ],
    benefits: [
      "Services for comprehensive whole-home plumbing inspections",
      ...
      "dispatching to homeowners preventative maintenance providers",
    ],
    problems: [
    ...
    detail: [
      {
        ...
        body: [
          ...
          "When home pressure is too high, it puts stress on the system. our licensed pros routinely test home pressure and install valves to protect the property.",
        ],
      },
    ],
    steps: [
      { title: "Evaluate", text: "The local pro assesses the overall health of the residential system." },
      { title: "Report", text: "The our licensed contractor provides a clear summary of findings to the homeowner." },
    ...
    faqs: [
      ...
      { q: "Can I hire someone to fix a leaking spigot in the backyard?", a: "Yes. We dispatch to homeowners pros who replace worn-out home hose bibbs." },
    ],
