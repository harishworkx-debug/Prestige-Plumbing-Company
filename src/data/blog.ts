...
export const posts: Post[] = [
  {
    ...
    takeaway:
      "Address slow drains while they are still merely slow. Prestige Plumbing Company clears and cameras drains across Mesa, Gilbert, Chandler and the Phoenix metro — call +1 (480) 215-0629 for flat-rate pricing before we start.",
  },
  {
    ...
    takeaway:
      "A maintained water heater in Arizona can reach twelve to fifteen years; a neglected one often fails at seven. Book a flush and anode inspection with Prestige Plumbing Company at +1 (480) 215-0629.",
  },
  {
    ...
    takeaway:
      "Prevention costs a fraction of restoration. Book a whole-home plumbing inspection with Prestige Plumbing Company at +1 (480) 215-0629 and get ahead of the failure.",
  },
  {
    ...
    takeaway:
      "If you have had the same line cleared more than once this year, jetting is the conversation worth having. Call Prestige Plumbing Company at +1 (480) 215-0629 for a camera inspection first.",
  },
  {
    ...
    takeaway:
      "We have worked on Mesa plumbing since 2005 and we know what your house is likely hiding. Call Prestige Plumbing Company at +1 (480) 215-0629 for a whole-home inspection.",
  },
  {
    ...
    takeaway:
      "If the annual items feel like more than you want to take on, we do all of them in a single visit. Call Prestige Plumbing Company at +1 (480) 215-0629.",
  },
  {
    ...
    takeaway:
      "Gas work belongs with licensed, permitted professionals. Prestige Plumbing Company installs and repairs gas piping throughout the East Valley — call +1 (480) 215-0629.",
  },
  {
    ...
    takeaway:
      "Simple parts are worth trying yourself. For anything involving the flange, the drain line, or water where it should not be, call Prestige Plumbing Company at +1 (480) 215-0629.",
  },
  {
    ...
    takeaway:
      "We perform the full checklist in one visit, including anode inspection and relief valve testing. Book water heater service with Prestige Plumbing Company at +1 (480) 215-0629.",
  },
  {
    ...
    takeaway:
      "If your meter is moving with everything off, do not wait. Prestige Plumbing Company locates hidden and slab leaks across Mesa and the Phoenix metro — call +1 (480) 215-0629.",
  },
];
