...
export const Route = createFileRoute("/services/")({
  head: () => ({
    meta: meta(
      ...
      "Full-service plumbing in Mesa & Phoenix: emergency plumbing, water heaters, drain cleaning, hydro jetting, leak detection, gas lines & repiping. Call +1 (480) 215-0629.",
      "/services",
    ),
